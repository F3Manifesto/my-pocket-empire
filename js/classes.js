...
class Fighter extends Sprite {
    constructor({position, velocity, color = 'red', imageSrc, 
                 scale = 1, framesMax = 1, offset = {x:0, y:0}, sprites, 
    ...
    update() {
        ...
        // gravity 
        if (this.position.y + this.height + this.velocity.y >= canvas.height - 114) {
            this.velocity.y = 0
            this.position.y = 312.14999
